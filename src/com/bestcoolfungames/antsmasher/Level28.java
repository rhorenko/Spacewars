...
public class Level28 extends GameSurface
{
  ...
  public void startPositions()
  {
    ...
    while (true)
    {
      ...
      do
        label549: i3 = rand.nextInt(this.numberOfObjects);
