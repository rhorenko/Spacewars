...
public class Level12 extends GameSurface
{
  public void startPositions()
  {
    ...
    while (true)
    {
      ...
      this.ants[b4][l].setPosition(160 - antWidth + (-1 + this.antOrder[b4][l] % 3) * antWidth, -50 - i1 * this.objectPadding);
      ++l;
    }
    label502: this.bees[i2] = new SurfaceBitmap();
  ...
  public void updatePositions()
  {
    ...
    while (true)
    {
      ...
      {
        if (160 - antWidth + (-1 + this.antOrder[b][i] % 3) * antWidth - this.ants[b][i].getLeft() > 0)
          this.antDirection[b][i] = 1;
        if (160 - antWidth + (-1 + this.antOrder[b][i] % 3) * antWidth - this.ants[b][i].getLeft() < -80)
          this.antDirection[b][i] = -1;
